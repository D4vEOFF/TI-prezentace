...
\draw[edge, dashed] (b1) -- (-3.6,\ydots+0.25);
\draw[edge, dashed] (b2) -- (-1.2,\ydots+0.25);
\draw[edge, dashed] (b3) -- ( 1.2,\ydots+0.25);
\draw[edge, dashed] (b4) -- ( 3.6,\ydots+0.25);
