...
\begin{document}
    ...
    \begin{frame}{Ohodnocený graf}{Příklad}
        \begin{figure}
            \centering
            \input{images/ohodnoceny-graf.tex}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{Vzdálenost vrcholů v ohodnoceném grafu}
        ...
        \visible<3->{\begin{figure}
            \centering
            \input{images/ohodnoceny-graf-vzdalenost-vrcholu.tex}
        \end{figure}}
    \end{frame}
    ...
    \begin{frame}{Hledání cest v ohodnocených grafech}
        ...
        \visible<5->{\begin{figure}
            \centering
            \input{images/ohodnoceny-graf-nejkratsi-cesta-2.tex}
        \end{figure}}
    \end{frame}
    ...
    \begin{frame}{Proč to funguje?}
        ...
        \visible<3->{\begin{figure}
            \centering
            \input{images/dijkstra-spravnost.tex}
        \end{figure}}
        \begin{itemize}
