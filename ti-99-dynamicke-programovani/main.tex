...
\begin{document}
    ...
    \begin{frame}{Kdy dynamické programování funguje?}
        ...
        \end{defblock}}
        \visible<3->{\begin{defblock}[Překrývající se podproblémy]
            Podproblémy se \markdarkred{překrývají}, pokud přímočará rekurze tentýž podproblém řeší \textbf{mnohokrát znovu}.
        \end{defblock}}
        \visible<4->{\begin{timportantframe}
            \begin{center}
                Teprve obě vlastnosti dohromady dělají dynamické programování výhodným.
            \end{center}
        \end{timportantframe}}
    \end{frame}
