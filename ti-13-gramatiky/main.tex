...
\begin{document}
    ...
    \centering
    \input{images/priklad-gramatiky-pro-anglickou-vetu.tex}
    \end{frame}
    ...
    \begin{frame}{Regulární gramatiky a regulární jazyky}
        ...
        \end{enumerate}
        \pause
        \begin{timportantframe}[.9\textwidth]
            \begin{center}
                Tedy regulární gramatiky generují právě regulární jazyky.
            \end{center}
        \end{timportantframe}
        \pause
        \begin{tinfoframe}[.8\textwidth]
            \begin{center}
    ...
    \centering
    \input{images/znazorneni-prevodu-automatu-na-regularni-gramatiku.tex}
    \end{frame}
    ...
    \begin{frame}{Jeden jazyk třemi způsoby}
        ...
        \begin{columns}[T]
            ...
            \begin{column}{0.48\textwidth}
                ...
                \begin{center}
                \input{images/jeden-jazyk-tremi-zpusoby.tex}
                \end{center}
